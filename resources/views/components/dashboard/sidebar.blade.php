            ...
            @if (auth()->user()->isSuperUser)
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu bg-transparent border-0">
                        <a href="{{ route('admin.home.view') }}" class="dropdown-item">Home</a>
                        <a href="{{ route('admin.jobListing.view') }}" class="dropdown-item">Job Listing</a>
                        <a href="{{ route('admin.blogs.view') }}" class="dropdown-item">Blogs</a>
                        <a href="{{ route('admin.singleBlog.view') }}" class="dropdown-item">Single Blog</a>
