    ...
    <div class="container-fluid pt-4 px-4">
        <div class="bg-light g-4">
            <div class="m-3 pt-3">
                ...
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="recentJobsHeading" placeholder="name@example.com">
                    <label for="floatingInput">Recent Jobs Heading *</label>
                </div>
                <div class="pt-3 pb-4">
    ...
    <script>
        ...
        async function get() {
            ...
            if (res.data['status'] === 'success') {
                ...
                document.getElementById('recentJobsHeading').value = data['description']['recentJobsHeading']
            } else {
        ...
        async function save() {
            ...
            let recentJobsHeading = document.getElementById('recentJobsHeading').value
            ...
            data.append('recentJobsHeading', recentJobsHeading)
